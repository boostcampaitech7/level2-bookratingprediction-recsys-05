...
python main.py  -c config/config_FFM_DCNV3_ensemble_MAE.yaml  -m FFM  -w True  -r FFM_seed1_mae --seed 1
python main.py  -c config/config_FFM_DCNV3_ensemble_MAE.yaml  -m FFM  -w True  -r FFM_seed2_mae --seed 2
python main.py  -c config/config_FFM_DCNV3_ensemble_MAE.yaml  -m FFM  -w True  -r FFM_seed3_mae --seed 3
python main.py  -c config/config_FFM_DCNV3_ensemble_MAE.yaml -m DCNV3  -w True  -r DCNV3_seed1_mae --seed 1
python main.py  -c config/config_FFM_DCNV3_ensemble_MAE.yaml -m DCNV3  -w True  -r DCNV3_seed2_mae --seed 2
python main.py  -c config/config_FFM_DCNV3_ensemble_MAE.yaml -m DCNV3  -w True  -r DCNV3_seed3_mae --seed 3
